...
% 1 Información del Documento %
\newcommand{\tfgtitlename}{Desarrollo de un sistema de pruebas de algoritmos de ECG para dispositivos portátiles}
\newcommand{\tfgtitlenameENG}{Development of an ECG algorithm benchmark system for portable devices}
