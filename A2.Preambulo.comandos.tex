...
% 1 Información del Documento %
\newcommand{\tfgtitlename}{Diseño, implementación y pruebas de un sistema de análisis ECG para dispositivos portátiles}
\newcommand{\tfgtitlenameENG}{Design, implementation and test of an ECG analysis system for portable devices}
