...
\section{Tercera iteración: Prototipo}
    ...
    Los requisitos a realizar en esta iteración son el 1.3.3 y el 1.3.4 de la tabla inicial (TODO: Referencia tabla de requisitos) junto al requisito 2.5 de la tabla completa (TODO: Referencia tabla final) añadido durante la iteración anterior. Para ello se divide el trabajo de la iteración en las siguientes tareas:
