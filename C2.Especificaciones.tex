...
\section{Metodología}
    ...
    Dada la naturaleza dual del proyecto se empleará una metodología de pruebas diferente para cada parte del proyecto. El panel de usuario será comprobado mediante \textit{Unit Testing} o pruebas unitarias. Para el dispositivo de pruebas se realizaran los tests mediante el \textit{debugger} y puntos de ruptura y mediante la coherencia de los datos retornados al panel.
